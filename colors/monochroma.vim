...
let s:orange          = { "gui": "#D75F5F", "cterm": "208" }
...
call s:h("Pmenu",         {"fg": s:bg, "bg": s:black})
call s:h("PmenuSel",      {"fg": s:black, "bg": s:bg})
call s:h("PmenuSbar",     {"fg": s:bg, "bg": s:black})
call s:h("PmenuThumb",    {"fg": s:bg, "bg": s:black})
...
" LspDiagnostics
call s:h("LspDiagnosticsDefaultHint",      {"fg": s:light_gray})
call s:h("LspDiagnosticsDefaultError",     {"fg": s:light_gray})
call s:h("LspDiagnosticsDefaultWarning",   {"fg": s:light_gray})
